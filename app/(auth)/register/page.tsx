    ...
    <div className="min-h-screen bg-[#0D1B2A] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/8 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
          ...
          <p className="text-white/40 text-sm mb-7">Free forever. No credit card needed.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gold-gradient text-navy-800 font-bold rounded-2xl text-sm shadow-gold hover:shadow-gold-lg transition-all hover:-translate-y-0.5 disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2 mt-6"
            >
              {loading ? (
                <>
